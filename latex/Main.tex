...
\end{figure}
\todo{mark right angles for radius lines to cone outline}
...
\end{align}
\todo{add another in-between step!}
...
\todo{moaaaar! tiny formulas. small sample image}
\\
...
\todo{recommend factor. write about extrem cases}
