...
\subsection{General Properties and Requirements of Dynamic Cache Placement} \label{sec:impl:dyncacheplace}
...
\todo{Add image here that demonstrates that only visibe caches are lit. Nice would be "view space inflicted shadow"}
