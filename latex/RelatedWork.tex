...
An irradiance volume is a regular grid in which each grid cell saves a precomputed irradiance values over all directions.
The original work uses hemispherical grid mappings to save irradiance values.
However, other representation like spherical harmonics are common in praxis \todo{citation?}.
