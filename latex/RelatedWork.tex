...
Because caches are often placed relatively sparse, most of the following techniques are prone to light bleeding artifacts, i.e. light "seeping" incorrectly through blockers.
