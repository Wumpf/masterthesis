...
\end{equation} 
$\mathrm{d}\omega$ denotes the differential steradian, while $\omega$ alone is a single direction on the unit hemisphere. \todo{recheck this expl}
...
\todo{currently there is only a bit on lighting, nothing more. introduction and title do not fit!}
...
Deferred shading decouples object rendering and pixel shading by saving all information needed for shading in the so called \emph{G-buffer}. \todo{gbuffer image!}
